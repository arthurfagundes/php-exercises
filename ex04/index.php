...
<head>
    ...
    <title>Exercício 04 - Bhaskara</title>
    ...
    <form action="index.php" method="POST">
        <div class="container py-4">
            <header class="pb-3 mb-4 border-bottom">
                <h1 class="display-1">Exercício 04 - Bhaskara</h1>
            </header>
                ...
                <div class="d-inline-flex">
                    ...
                    if (isset($_POST['result'])) {
                        ...
                        if ($delta > 0) {
                            $x1 = (-$b + $delta) / (2 * $a);
                            $x2 = (-$b - $delta) / (2 * $a);
                            echo "<p  class='text-danger fs-3'>Resultado: <br>x': $x1 <br>x'': $x2</p>";
                        } else {
                            echo "<p  class='text-danger fs-3'>Resultado: Delta negativo</p>";
                        }
                    }
                    ?>
                </div>
